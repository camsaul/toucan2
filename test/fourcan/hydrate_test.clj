(ns fourcan.hydrate-test
  (:require [clojure.test :refer :all]
            [fourcan.hydrate :as hydrate]
...
(m/defmethod hydrate/automagic-hydration-key-model ::user
      [_]
  :user)

(m/defmethod hydrate/automagic-hydration-key-model ::venue
  [_]
  :venue)
