(ns toucan2.instance-2-test
  (:require
   [clojure.test :refer :all]
   [methodical.core :as m]
   [toucan2.instance-2 :as instance]
...
(deftest instance-test-2
  ...
  (let [m (instance/instance ::MyModel {:original? true})]
    ...
    (is (= {:original? true}
           (.m m)))
    (is (= {:original? true}
           (.orig ^toucan2.instance_2.Instance (assoc m :original? false))))
    (is (= {:original? false}
           (.m ^toucan2.instance_2.Instance (assoc m :original? false))))
