...
(deftest instance-test
  (let [m (assoc (instance/instance :wow {:a 100}) :b 200)]
    ...
    (testing "current"
      (is (= {:a 100, :b 200}
             (instance/current m)))
      (is (not (instance/toucan2-instance? (instance/current m)))))))
...
(deftest pretty-print-test
  (testing "Should pretty-print"
    (binding [*ns* (the-ns 'toucan2.instance-test)]
    ...
    (testing "Should use appropriate alias for current namespace"
      (try
        ...
        (require '[toucan2.core :as toucan2])
        (is (= "(toucan2/instance :venues {:id 1})"
               (pr-str (instance/instance :venues {:id 1}))))
        (finally
          (require '[toucan2.instance :as instance])
          (ns-unalias *ns* 'toucan2)))
      (binding [*ns* (the-ns 'toucan2.instance)]
...
(deftest reset-original-test
  ...
  (testing "No-op for non-instances"
    (let [result (instance/reset-original {:a 1})]
      ...
      (is (not (instance/toucan2-instance? result))))))
